...
public class NomineeListController {
    ...
    @PostMapping("/updateShortlistStatus")
    public ResponseEntity<Map<String, String>> updateShortlistStatus(@RequestBody List<Map<String, Object>> shortlistedEmployees) {
        Map<String, String> response = nomineeListService.updateShortlistStatus(shortlistedEmployees);
